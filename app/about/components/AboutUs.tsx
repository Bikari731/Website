    ...
    <section className="bg-white text-black py-16 sm:px-6 lg:px-8 overflow-hidden" aria-labelledby="about-us-heading">
      <div className="w-full mx-auto px-4 md:px-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-20 min-h-[100vh]">
          ...
          <AnimateInView direction="right" className="relative grid grid-cols-1 md:grid-cols-2 gap-4 auto-rows-fr h-[450px] w-full lg:w-[50%]" aria-label="About us gallery">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.items.map((item, index) => (
              <AnimateInView key={index} direction="up" delay={index * 0.1}>
                <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 group">
